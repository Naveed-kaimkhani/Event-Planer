...
class Firestore_method {
  ...
  static Future uploadDataToFirestore(
...
//
  Future<User_Details?> getUserDetails() async {
    ...
    User_Details user_details =
        User_Details.getModelFromJson(snapshot.data() as dynamic);
  ...
  static Future<List<eventModel>> getDataFromCategory(
  ...
  static Future<List<eventModel>> UserUploadedEvents(
